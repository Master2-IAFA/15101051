...
void Octree<Data>::subDivise(){
    ...
    _children[4] = new Octree<Data>(_depth + 1, center, _min);
    _children[5] = new Octree<Data>(_depth + 1, center, glm::vec3(_max[0], _min[1], _min[2]));
    _children[6] = new Octree<Data>(_depth + 1, center, glm::vec3(_min[0], _max[1], _min[2]));
    _children[7] = new Octree<Data>(_depth + 1, center, glm::vec3(_max[0], _max[1], _min[2]));
